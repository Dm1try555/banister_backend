...
from core.mail.mixins import MailMixin
...
class User(AbstractBaseUser, PermissionsMixin, MailMixin):
    ROLE_CHOICES = (
        ('customer', 'Customer'),
        ('provider', 'Provider'),
    ...
    fcm_token = models.CharField(max_length=500, blank=True, null=True, help_text="Firebase Cloud Messaging token for push notifications")
