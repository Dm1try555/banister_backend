...
from apps.providers.models import Provider # Ensure this import is correct and Provider model exists
...
class BaseUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'phone', 'role', 'fcm_token', 'profile', 'profile_photo_url', 'has_required_profile_photo']
...
class ProviderUserSerializer(BaseUserSerializer):
    ...
    class Meta(BaseUserSerializer.Meta):
        fields = ['id', 'email', 'phone', 'role', 'fcm_token', 'profile', 'provider_profile', 'profile_photo_url', 'has_required_profile_photo']
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['email', 'phone', 'role', 'fcm_token', 'password', 'confirm_password', 'first_name', 'last_name']
    ...
    def create(self, validated_data):
        ...
        if fcm_token:
            ...
            user.save()
            logger.info(f"FCM token saved for new user {user.email}")
