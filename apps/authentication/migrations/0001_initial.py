    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('provider', 'Provider'), ('management', 'Management'), ('admin', 'Admin'), ('super_admin', 'Super Admin')], default='customer', max_length=20)),
                ...
                ('provider_hourly_rate', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
